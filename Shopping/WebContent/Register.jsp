		...
		<div id="table">
		       <div id="biaokaung">
				<div id="tb_01">
					...
					<div><span class="pagename">用户名</span><input type="text" placeholder="你的账户名和登录名"/></div>
				</div>
				...
				<div id="tb_03">
					...
					<div><span class="pagename">确认密码</span><input type="password" placeholder="再次输入密码"/></div>
				</div>
				<div id="tb_04">
